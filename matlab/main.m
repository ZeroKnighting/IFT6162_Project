...
%% Save deterministic MPC and RBC results for later comparison
save('deterministic_run.mat','falh','falc','faly','falmv','trueh','truec','truey','truemv','mpc_ekfh','mpc_ekfc','mpc_ekfy','mpc_ekfmv','hh','cc','yy','mvmv','qin_t','hlimit');
